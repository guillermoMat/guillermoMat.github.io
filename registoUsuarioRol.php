...
<body>
    <div id="login">
        <h2 class="text-center text-white pt-5" style="text-decoration:underline;">Paso 1</h2>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="registro_usuario.php" method="post">
                            ...
                            <a href="iniciar_sesion.php" style="display: flex;justify-content: flex-end;">Regresar</a>
